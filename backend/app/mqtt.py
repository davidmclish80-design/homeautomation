...
class MQTT:
    ...
    sub_topics = [("620171852", 0), ("620171852_sub", 0), ("/elet2415", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620171852_sub", self.toggle)
